...
type FlatConfig struct {
	...
	CloudProviderDetectionCommand      *string           `mapstructure:"cloud_provider_detection_command" cty:"cloud_provider_detection_command" hcl:"cloud_provider_detection_command"`
	CloudProviderDetectionIsEnabled    *bool             `mapstructure:"cloud_provider_detection_is_enabled" cty:"cloud_provider_detection_is_enabled" hcl:"cloud_provider_detection_is_enabled"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"cloud_provider_detection_command":    &hcldec.AttrSpec{Name: "cloud_provider_detection_command", Type: cty.String, Required: false},
		"cloud_provider_detection_is_enabled": &hcldec.AttrSpec{Name: "cloud_provider_detection_is_enabled", Type: cty.Bool, Required: false},
